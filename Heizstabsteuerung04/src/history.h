...
//   - Long-term: 15min average (downsampled), 7 days retention = 672 samples
//     (so ~5 days remain at 15min resolution after the 2-day short window)
//
...
// Long-term: 15min average, 7 days = 672 samples
static constexpr size_t CAPACITY_LONG = 672;
